...
namespace hotelreser.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Search(string Searchby, string search)
        {
            ...
            {
                var model = db.bookings.Where(room => room.roomtype == search || search == null).ToList();
                return View(model);

            }
            else
            {
                var model = db.bookings.Where(room => room.Email == search || search == null).ToList();
                    return View(model);
            }
            //else
            //{
